...
*This is the easiest option. The app will load quickly, but due to limits on the number of users it may not always be accessible.*
...
*This provides a backup option that is equivalent to the first, but will load more slowly.*

3. **Download this repo and run Growth Curve FittR on your own computer**

*[Instructions below](##Local) will guide you to get the app set up to run on your own computer*
